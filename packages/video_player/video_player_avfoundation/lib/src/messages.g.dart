...
class AVFoundationVideoPlayerApi {
  ...
  Future<void> setMaxResolution(SetMaxResolutionMessage arg_msg) async {
    const String channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setMaxResolution';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
  ...
  Future<void> setBufferWindow(SetBufferWindowMessage arg_msg) async {
    const String channelName = 'dev.flutter.pigeon.video_player_avfoundation.AVFoundationVideoPlayerApi.setBufferWindow';
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      channelName,
      codec,
      binaryMessenger: _binaryMessenger,
