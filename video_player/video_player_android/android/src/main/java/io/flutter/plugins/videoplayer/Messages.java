...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class GetMaxInstancesMessage {
    private @NonNull String mediaType;

    public @NonNull String getMediaType() {
      return mediaType;
    }

    public void setMediaType(@NonNull String setterArg) {
      if (setterArg == null) {
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setMediaType(@NonNull String setterArg) {
        this.mediaType = setterArg;
        return this;
      }

      public @NonNull GetMaxInstancesMessage build() {
        GetMaxInstancesMessage pigeonReturn = new GetMaxInstancesMessage();
    ...
    static @NonNull GetMaxInstancesMessage fromList(@NonNull ArrayList<Object> list) {
      GetMaxInstancesMessage pigeonResult = new GetMaxInstancesMessage();
      Object mediaType = list.get(0);
      pigeonResult.setMediaType((String) mediaType);
      return pigeonResult;
    }
  }

  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class SetMaxResolutionMessage {
    private @NonNull Long textureId;
    ...
    public static final class Builder {
      ...
      public @NonNull SetMaxResolutionMessage build() {
        SetMaxResolutionMessage pigeonReturn = new SetMaxResolutionMessage();
        pigeonReturn.setTextureId(textureId);
    ...
    static @NonNull SetMaxResolutionMessage fromList(@NonNull ArrayList<Object> list) {
      SetMaxResolutionMessage pigeonResult = new SetMaxResolutionMessage();
      Object textureId = list.get(0);
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer) textureId : (Long) textureId));
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class SetBufferWindowMessage {
    private @NonNull Long textureId;
    ...
    public @Nullable Long getSeconds() {
      return seconds;
    }

    public void setSeconds(@Nullable Long setterArg) {
      this.seconds = setterArg;
    }

    /** Constructor is non-public to enforce null safety; use Builder. */
    SetBufferWindowMessage() {}
    ...
    public static final class Builder {
      ...
      @CanIgnoreReturnValue
      public @NonNull Builder setSeconds(@Nullable Long setterArg) {
        this.seconds = setterArg;
        return this;
      }

      public @NonNull SetBufferWindowMessage build() {
        SetBufferWindowMessage pigeonReturn = new SetBufferWindowMessage();
        pigeonReturn.setTextureId(textureId);
        pigeonReturn.setSeconds(seconds);
        return pigeonReturn;
      }
    }
    ...
    ArrayList<Object> toList() {
      ArrayList<Object> toListResult = new ArrayList<Object>(2);
      toListResult.add(textureId);
      toListResult.add(seconds);
      return toListResult;
    }

    static @NonNull SetBufferWindowMessage fromList(@NonNull ArrayList<Object> list) {
      SetBufferWindowMessage pigeonResult = new SetBufferWindowMessage();
      Object textureId = list.get(0);
      pigeonResult.setTextureId((textureId == null) ? null : ((textureId instanceof Integer) ? (Integer) textureId : (Long) textureId));
      Object seconds = list.get(1);
      pigeonResult.setSeconds((seconds == null) ? null : ((seconds instanceof Integer) ? (Integer) seconds : (Long) seconds));
      return pigeonResult;
    }
  }
  ...
  private static class AndroidVideoPlayerApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 129:
          return GetMaxInstancesMessage.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 130:
        ...
        case (byte) 134:
          return SetBufferWindowMessage.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 135:
          return SetMaxResolutionMessage.fromList((ArrayList<Object>) readValue(buffer));
        case (byte) 136:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof GetMaxInstancesMessage) {
        stream.write(129);
        writeValue(stream, ((GetMaxInstancesMessage) value).toList());
      ...
      } else if (value instanceof SetBufferWindowMessage) {
        stream.write(134);
        writeValue(stream, ((SetBufferWindowMessage) value).toList());
      } else if (value instanceof SetMaxResolutionMessage) {
        stream.write(135);
        writeValue(stream, ((SetMaxResolutionMessage) value).toList());
  ...
  public interface AndroidVideoPlayerApi {
    ...
    @NonNull 
    Long getMaxInstances(@NonNull GetMaxInstancesMessage msg);

    void setMaxResolution(@NonNull SetMaxResolutionMessage msg);

    void setBufferWindow(@NonNull SetBufferWindowMessage msg);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @Nullable AndroidVideoPlayerApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.getMaxInstances", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                GetMaxInstancesMessage msgArg = (GetMaxInstancesMessage) args.get(0);
                try {
                  Long output = api.getMaxInstances(msgArg);
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setMaxResolution", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                SetMaxResolutionMessage msgArg = (SetMaxResolutionMessage) args.get(0);
                try {
                  api.setMaxResolution(msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.video_player_android.AndroidVideoPlayerApi.setBufferWindow", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                SetBufferWindowMessage msgArg = (SetBufferWindowMessage) args.get(0);
                try {
                  api.setBufferWindow(msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
